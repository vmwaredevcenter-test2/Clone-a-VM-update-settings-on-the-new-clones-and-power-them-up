...
public class CloneAndChangeVM {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 6) {
            ...
            System.out.println("[4] The name of the virtual machine to clone");
            System.out.println("[5] The number of clones to make");
            System.out.println("[6] The base name of each new clone");
            System.exit(1);
        }

        try {
            numberOfNewVms = Integer.parseInt(args[4]);
        } catch (NumberFormatException nfe) {
            System.out.printf("The fifth argument [%s] is not a number, and must be.%n", args[4]);
        }
